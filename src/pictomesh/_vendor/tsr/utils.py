...
def find_class(cls_string):
    ...
    # config.yaml names classes under the upstream ``tsr`` package; map onto this one.
    if module_string == "tsr" or module_string.startswith("tsr."):
        module_string = __package__ + module_string[len("tsr"):]
