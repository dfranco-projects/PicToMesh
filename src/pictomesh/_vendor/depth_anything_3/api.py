...
from pictomesh._vendor.depth_anything_3.cfg import create_object, load_config
from pictomesh._vendor.depth_anything_3.registry import MODEL_REGISTRY
from pictomesh._vendor.depth_anything_3.specs import Prediction
from pictomesh._vendor.depth_anything_3.utils.geometry import affine_inverse
from pictomesh._vendor.depth_anything_3.utils.io.input_processor import InputProcessor
from pictomesh._vendor.depth_anything_3.utils.io.output_processor import OutputProcessor
from pictomesh._vendor.depth_anything_3.utils.logger import logger
...
class DepthAnything3(nn.Module, PyTorchModelHubMixin):
    ...
    def forward(
        ...
        with torch.no_grad():
            with torch.autocast(device_type=image.device.type, dtype=autocast_dtype, enabled=use_autocast):
                return self.model(
